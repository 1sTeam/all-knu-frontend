        ...
        <div class="setting-wrapper">
          ...
          <div class="setting-body">
            <div class="setting-save">
              ...
              <v-btn color="mainColor" v-on:click="onClickSaveAlarm"
                >저장</v-btn
              >
            </div>
            ...
            <div class="setting-subscribe">
              ...
              <div class="switch">
                <div class="switch-item">
                  <span
                    v-text="this.subscribeModel.department[0].korean"
                  ></span>
                  <v-switch
                    v-model="subscribeModel.department[0].isSubscribe"
                    color="mainColor"
                    hide-details
                  ></v-switch>
                </div>
                <div class="switch-item">
                  <span
                    v-text="this.subscribeModel.department[1].korean"
                  ></span>
                  <v-switch
                    v-model="subscribeModel.department[1].isSubscribe"
                    color="mainColor"
                    hide-details
                  ></v-switch>
                </div>
                <div class="switch-item">
                  <span
                    v-text="this.subscribeModel.department[2].korean"
                  ></span>
                  <v-switch
                    v-model="subscribeModel.department[2].isSubscribe"
                    color="mainColor"
                    hide-details
                  ></v-switch>
                </div>
                <div class="switch-item">
                  <span
                    v-text="this.subscribeModel.department[3].korean"
                  ></span>
                  <v-switch
                    v-model="subscribeModel.department[3].isSubscribe"
                    color="mainColor"
                    hide-details
                  ></v-switch>
                </div>
    ...
    onClickSaveAlarm() {
      ...
      if (real) {
        ...
        if (this.userFcmToken != null) {
          ...
          axios
            .post(
              "https://all-knu-backend.accongbox.com/dev/fcm/subscribe",
              body
            )
            .then((response) => {
